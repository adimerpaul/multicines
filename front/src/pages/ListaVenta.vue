<template>
  <q-page>
    <div class="row">
      ...
      <div class="col-12">
        <q-table :rows="listaVentaBoleteria" :columns="listaColums" :filter="filter" dense wrap-cells>
    ...
    <!--qdialog muestre tipo pago tipo toggle true -->
...
//     d.print( document.getElementById('myelement'), [ cssText ] )
  ...
  methods: {
    ...
    exportar(){
      ...
      let settings = {
        fileName: "VentaBoleteria" + date.formatDate(new Date(), "YYYY-MM-DD"),
